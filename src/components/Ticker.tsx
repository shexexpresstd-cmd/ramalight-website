export default function Ticker() {
  ...
  return (
    <div className="bg-brand py-3 overflow-hidden relative">
      <div className="flex gap-0 w-max" style={{ animation: 'tickerScroll 25s linear infinite' }}>
        {doubled.map((t, i) => (
          <div key={i} className="flex items-center gap-3 px-8 text-[13px] font-bold text-white/80 whitespace-nowrap font-syne tracking-[0.5px]">
            {t}
