          ...
          <motion.div className="bg-white p-8 rounded-xl border border-surface-200"
            ...
            <form className="space-y-4" onSubmit={e => e.preventDefault()}>
              <div className="grid sm:grid-cols-2 gap-4">
                <input type="text" placeholder="Full Name" className="w-full px-4 py-3 border border-surface-200 rounded-lg text-sm focus:outline-none focus:border-accent focus:shadow-[0_0_0_3px_rgba(13,51,32,0.08)] transition-all" />
                <input type="email" placeholder="Email Address" className="w-full px-4 py-3 border border-surface-200 rounded-lg text-sm focus:outline-none focus:border-accent focus:shadow-[0_0_0_3px_rgba(13,51,32,0.08)] transition-all" />
              </div>
              <input type="text" placeholder="Company / Organization" className="w-full px-4 py-3 border border-surface-200 rounded-lg text-sm focus:outline-none focus:border-accent focus:shadow-[0_0_0_3px_rgba(13,51,32,0.08)] transition-all" />
              <textarea rows={4} placeholder="Tell us about your requirements..." className="w-full px-4 py-3 border border-surface-200 rounded-lg text-sm focus:outline-none focus:border-accent focus:shadow-[0_0_0_3px_rgba(13,51,32,0.08)] transition-all resize-y" />
              <button type="submit" className="w-full px-6 py-4 text-base font-semibold bg-gradient-to-br from-accent to-accent-light text-white rounded-lg hover:-translate-y-0.5 hover:shadow-[0_8px_30px_rgba(13,51,32,0.35)] transition-all inline-flex items-center justify-center gap-2">
                Send Message
              </button>
            </form>
          </motion.div>
