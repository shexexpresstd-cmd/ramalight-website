    ...
    <section className="section-pad">
      <div className="container-xl">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {apps.map((a, i) => (
            <AnimateIn key={a.title} delay={i * 0.15}>
              <motion.div
                className="group bg-white border border-slate-200 rounded-xl p-8 hover:border-transparent cursor-pointer"
              ...
              >
                <div className="w-13 h-13 rounded-[10px] bg-slate-50 flex items-center justify-center mb-5 group-hover:bg-accent-pale transition-colors">
                  <a.icon size={24} className="text-brand/60 group-hover:text-accent transition-colors" />
                </div>
