        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-7">
          {sizes.map((s, i) => (
            <motion.div key={s.size} className={`bg-white rounded-xl border p-8 text-center ${s.color} hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.06)] transition-all duration-300 group`}
              ...
              <div className="w-16 h-16 mx-auto rounded-2xl bg-surface-50 flex items-center justify-center mb-5 group-hover:scale-110 group-hover:bg-accent-pale transition-all">
                <s.icon size={28} className="text-muted-500 group-hover:text-accent transition-colors" />
              </div>
