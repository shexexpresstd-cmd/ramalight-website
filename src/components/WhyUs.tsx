    ...
    <section className="section section-dark" id="why">
      <div className="container-xl px-10">
        <motion.div className="text-center mb-16" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          <div className="section-tag justify-center" style={{ color: '#f0c040' }}>Why Ramalight</div>
          <h2 className="font-syne text-[46px] font-extrabold tracking-[-1.2px] leading-[1.1] mb-4 text-white">Why Choose <span className="text-gradient-gold">Our Bleach</span></h2>
          <p className="text-[17px] text-white/40 leading-relaxed max-w-[580px] mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {reasons.map((r, i) => (
            <motion.div key={r.num} className="text-center group cursor-default"
              ...
              <div className="text-5xl font-black text-gold-light tracking-[-1px] mb-3 font-syne">{r.num}</div>
