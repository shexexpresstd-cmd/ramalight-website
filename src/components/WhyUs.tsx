    ...
    <section className="section-pad bg-navy-50">
      <div className="container-xl">
        <div className="flex items-center gap-3 mb-3">
          <span className="w-5 h-0.5 bg-gold-light" />
          <span className="text-xs font-bold tracking-[2px] uppercase text-gold-light">
            Why Ramalight
          </span>
        </div>
        <h2 className="text-4xl lg:text-5xl font-black tracking-[-1px] mb-4 text-white">
          Why Choose <span className="text-gold">Our Bleach</span>
        </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {reasons.map((r) => (
            <div key={r.num} className="text-center">
              <div className="text-5xl font-black text-gold tracking-[-1px] mb-3">
                {r.num}
              </div>
